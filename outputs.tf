...
output "compartment-state" {
  value = oci_identity_compartment.tf-compartment.state
}

output "compartment-time_created" {
  value = oci_identity_compartment.tf-compartment.time_created
}

# Output for The "name" of the availability domain to be used for the compute instance.
